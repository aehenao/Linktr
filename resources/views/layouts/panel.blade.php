...
<div class="user-profile__social__links">
  @foreach($footers as $footer)
    ...
    <a href="/footer/{{$footer->id}}" target="_blank" rel="noopener" class="user-profile__social__links__item">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Content +18 years</h5>
       {{--  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> --}}
      </div>
      <div class="modal-body">
        <p>The content of this website is for people over 18 years of age. Do you agree to be over 18 years of age?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary btnNo" data-bs-dismiss="modal">I'm not</button>
        <button type="button" class="btn text-white btnAcepto" style="background-color: #f348a7;">Yes I am</button>
      </div>
    </div>
  </div>
</div>
